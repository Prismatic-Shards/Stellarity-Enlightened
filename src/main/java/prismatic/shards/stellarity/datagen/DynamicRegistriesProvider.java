...
public class DynamicRegistriesProvider extends FabricDynamicRegistryProvider {
	...
	public void configure(HolderLookup.@NonNull Provider provider, @NonNull Entries entries) {
		for (var registry : List.of(PAINTING_VARIANT, COW_VARIANT, FROG_VARIANT, CAT_VARIANT, WOLF_VARIANT, CHICKEN_VARIANT, CONFIGURED_FEATURE, PLACED_FEATURE, BIOME, VILLAGER_TRADE, TRADE_SET)) {
