...
public class BlockTagProvider extends FabricTagsProvider.BlockTagsProvider {
	...
	protected void addTags(HolderLookup.@NonNull Provider provider) {
		...
		addTags(WORLDGEN_THE_NEST_SURFACE, BlockTags.TERRACOTTA, StellarityBlockTags.DIRT).add(END_STONE, BASALT, DEEPSLATE, TUFF, ANDESITE, COBBLESTONE, CRYING_OBSIDIAN, OBSIDIAN, NETHERRACK);
	}
}
