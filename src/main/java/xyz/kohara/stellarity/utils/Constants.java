...
public class Constants {
	public static final List<SpikeFeature.EndSpike> OBSIDIAN_SPIKES;

	static {
		var altarSpike = new SpikeFeature.EndSpike(50, -39, 8, 105, false);
		altarSpike.stellarity$setAltar(true);
		OBSIDIAN_SPIKES = List.of(
