...
public class Constants {
	public static final List<SpikeFeature.EndSpike> OBSIDIAN_SPIKES = List.of(
		...
		ExtEndSpike.apply(new SpikeFeature.EndSpike(18, 59, 4, 94, true), false, true),
		...
		ExtEndSpike.apply(new SpikeFeature.EndSpike(-63, 0, 5, 93, true), false, true),
		...
		ExtEndSpike.apply(new SpikeFeature.EndSpike(18, -60, 5, 87, true), false, true),
		ExtEndSpike.apply(new SpikeFeature.EndSpike(50, -39, 8, 105, true), true, true)
	);
}
