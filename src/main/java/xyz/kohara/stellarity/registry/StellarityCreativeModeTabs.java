...
public class StellarityCreativeModeTabs {
    ...
    public static final CreativeModeTab FOOD = CreativeTabRegistry.create(builder -> builder
        .icon(() -> new ItemStack(StellarityItems.SUSHI))
        .title(Component.translatable("itemGroup.stellarity.food"))
        .build());
    public static final CreativeModeTab BLOCKS = CreativeTabRegistry.create(builder -> builder
        .icon(() -> new ItemStack(StellarityItems.ENDER_GRASS_BLOCK))
        .title(Component.translatable("itemGroup.stellarity.blocks"))
        .build());
    public static final CreativeModeTab EQUIPMENT = CreativeTabRegistry.create(builder -> builder
        .icon(() -> new ItemStack(StellarityItems.CALL_OF_THE_VOID))
        .title(Component.translatable("itemGroup.stellarity.equipment"))
        .build());
    public static final CreativeModeTab INGREDIENTS = CreativeTabRegistry.create(builder -> builder
        .icon(() -> new ItemStack(StellarityItems.ENDERITE_SHARD))
        .title(Component.translatable("itemGroup.stellarity.ingredients"))
        .build());
    public static final CreativeModeTab TRINKETS = CreativeTabRegistry.create(builder -> builder
    ...
    private static CreativeModeTab register(ResourceKey<CreativeModeTab> key, CreativeModeTab tab, ItemLike[] items, ItemStack[] stacks) {
        Registry.register(CREATIVE_MODE_TAB, key, tab);
        CreativeTabRegistry.appendBuiltin(tab, items);
        CreativeTabRegistry.appendBuiltinStack(tab, stacks);
        return tab;
    }
    
    private static CreativeModeTab register(ResourceKey<CreativeModeTab> key, CreativeModeTab tab, ItemLike[] items) {
        return register(key, tab, items, new ItemStack[0]);
    }
}
