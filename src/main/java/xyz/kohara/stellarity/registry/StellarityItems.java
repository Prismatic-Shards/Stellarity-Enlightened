...
public class StellarityItems {
    ...
    public static final BlockItem ROOTED_ENDER_DIRT = registerBlock("rooted_ender_dirt", StellarityBlocks.ROOTED_ENDER_DIRT);
    public static final BlockItem ENDER_DIRT_PATH = registerBlock("ender_dirt_path", StellarityBlocks.ENDER_DIRT_PATH);
    public static final BlockItem ALTAR_OF_THE_ACCURSED = registerBlock("altar_of_the_accursed", StellarityBlocks.ALTAR_OF_THE_ACCURSED);

    public static final CallOfTheVoid CALL_OF_THE_VOID = register("call_of_the_void", CallOfTheVoid::new, CallOfTheVoid.properties());
    public static final FisherOfVoids FISHER_OF_VOIDS = register("fisher_of_voids", FisherOfVoids::new, FisherOfVoids.properties());

    // food items start
    public static final Item SUSHI = register("sushi", Item::new, basicFood(4, 2.4f));
    public static final GoldenChorusFruit GOLDEN_CHORUS_FRUIT = register("golden_chorus_fruit", GoldenChorusFruit::new, GoldenChorusFruit.properties());
    public static final FriedChorusFruit FRIED_CHORUS_FRUIT = register("fried_chorus_fruit", FriedChorusFruit::new, FriedChorusFruit.properties());
    public static final Item FROZEN_CARPACCIO = register("frozen_carpaccio", Item::new, basicFood(7, 8.4f));
    public static final EndermanFlesh ENDERMAN_FLESH = register("enderman_flesh", EndermanFlesh::new, EndermanFlesh.properties());
    public static final CrystalHeartfish CRYSTAL_HEARTFISH = register("crystal_heartfish", CrystalHeartfish::new, CrystalHeartfish.properties());
    ...
    public static final ShulkerBody SHULKER_BODY = register("shulker_body", ShulkerBody::new, ShulkerBody.properties());
    ...
    public static final PhantomItemFrameItem PHANTOM_ITEM_FRAME = register("phantom_item_frame", PhantomItemFrameItem::new, new ItemFrameItem.Properties().stacksTo(16));
    ...
    public static final Tamaris TAMARIS = register("tamaris", Tamaris::new, Tamaris.properties());
    ...
    public static final PrismaticPearlItem PRISMATIC_PEARL = register("prismatic_pearl", PrismaticPearlItem::new, PrismaticPearlItem.properties());
    public static final Endonomicon ENDONOMICON = register("endonomicon", Endonomicon::new, Endonomicon.properties());
