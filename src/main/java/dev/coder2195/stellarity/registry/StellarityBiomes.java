...
public interface StellarityBiomes {
	...
	static void bootstrap(BootstrapContext<Biome> context) {
		...
		var worldCarvers = context.lookup(Registries.CARVER);
		...
		context.register(AMETHYST_FOREST, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				...
				.addSpawn(EntityTypes.COW, 8, 1, 4)
				.addSpawn(EntityTypes.WOLF, 8, 1, 4)
				.build()
		...
		context.register(ASHFALL_DELTAS, new Biome.BiomeBuilder()
			...
			.setAttribute(EnvironmentAttributes.CREATURE_WORLD_GEN_SPAWN_PROBABILITY, 0.2f)
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(StellarityEntityTypes.VOIDED_SKELETON, 11, 2, 2)
				.addSpawn(EntityTypes.FROG, 100, 1, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SLIME, 20, 1, 2)
				.build())
			.generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
		...
		context.register(CRYSTAL_CRAGS, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.ENDERMAN, 20, 4, 4)
				.addMobSpawnCost(EntityTypes.ENDERMAN, 0.7, 1)
				.build())
			.generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, GLOBAL_STALACTITES)
		...
		var shrubLandWildsEntities = new MobSpawnSettings.Builder()
			.addSpawn(EntityTypes.ENDERMAN, 60, 4, 4)
			.addSpawn(StellarityEntityTypes.VOIDED_ZOMBIE, 30, 4, 4)
			.addSpawn(EntityTypes.PHANTOM, 10, 4, 4)
			.addSpawn(EntityTypes.SHEEP, 12, 1, 4)
			.addSpawn(EntityTypes.PIG, 10, 1, 4)
			.addSpawn(EntityTypes.CHICKEN, 10, 1, 4)
			.addSpawn(EntityTypes.COW, 8, 1, 4)
			.addSpawn(EntityTypes.WOLF, 8, 1, 4)
			.addMobSpawnCost(EntityTypes.ENDERMAN, 0.7, 1)
			.addMobSpawnCost(StellarityEntityTypes.VOIDED_ZOMBIE, 0.7, 1)
			.addMobSpawnCost(EntityTypes.PHANTOM, 0.7, 1)
			.build();
		...
		context.register(ENDER_WASTES, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.ENDERMAN, 40, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SKELETON, 5, 2, 3)
				.addMobSpawnCost(EntityTypes.ENDERMAN, 0.6, 1)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SKELETON, 0.6, 1)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, GLOBAL_STALACTITES)
		...
		context.register(ENDLESS_DUNES, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.ENDERMAN, 80, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_ZOMBIE, 30, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SKELETON, 15, 4, 4)
				.addMobSpawnCost(EntityTypes.ENDERMAN, 1, 0.3)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_ZOMBIE, 1, 0.14)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SKELETON, 1, 0.15)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
		...
		context.register(FIERY_HILLS, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.MAGMA_CUBE, 20, 1, 2)
				.addMobSpawnCost(EntityTypes.MAGMA_CUBE, 1, 0.18)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, GLOBAL_STALACTITES)
		...
		context.register(FLESH_TUNDRA, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(StellarityEntityTypes.VOIDED_SILVERFISH, 7, 2, 2)
				.addSpawn(StellarityEntityTypes.VOIDED_SKELETON, 15, 2, 2)
				.addSpawn(StellarityEntityTypes.FLESH_PIGLIN, 40, 4, 4)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SKELETON, 1, 0.8f)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SILVERFISH, 1, 0.5f)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
		...
		context.register(FROSTED_VALLEY, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.ENDERMAN, 50, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SKELETON, 40, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SILVERFISH, 10, 2, 2)
				.addMobSpawnCost(EntityTypes.ENDERMAN, 1, 0.4)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SKELETON, 1, 0.4)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SILVERFISH, 1, 0.5)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, GLOBAL_STALACTITES)
		...
		context.register(FROZEN_SHRUBLAND, new Biome.BiomeBuilder()
			...
			.specialEffects(new BiomeSpecialEffects(0x3d57d6, of(0xffffff), empty(), of(0xffffff), BiomeSpecialEffects.GrassColorModifier.NONE))
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.ENDERMAN, 45, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SKELETON, 35, 4, 4)
				.addSpawn(StellarityEntityTypes.VOIDED_SILVERFISH, 10, 2, 2)
				.addSpawn(EntityTypes.PHANTOM, 15, 2, 2)
				.addMobSpawnCost(EntityTypes.ENDERMAN, 1, 0.6)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SKELETON, 1, 0.4)
				.addMobSpawnCost(StellarityEntityTypes.VOIDED_SILVERFISH, 1, 0.5)
				.addMobSpawnCost(EntityTypes.PHANTOM, 1, 0.3)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, GLOBAL_STALACTITES)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, FROZEN_SPIKES_LARGE_DRIPSTONE)
		...
		context.register(HALLOWED_TUNDRA, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(StellarityEntityTypes.PIXIE, 20, 1, 2)
				.addMobSpawnCost(StellarityEntityTypes.PIXIE, 1, 0.25)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, GLOBAL_STALACTITES)
				.addFeature(GenerationStep.Decoration.RAW_GENERATION, FROZEN_SPIKES_LARGE_DRIPSTONE)
		...
		context.register(PRISMARINE_FOREST, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				...
				.addSpawn(EntityTypes.COW, 8, 1, 4)
				.addSpawn(EntityTypes.WOLF, 8, 1, 4)
				.addSpawn(EntityTypes.FROG, 8, 1, 4)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addCarver(StellarityConfiguredCarvers.RAVINE)
				.addCarver(StellarityConfiguredCarvers.CRACK)
		...
		context.register(THE_NEST, new Biome.BiomeBuilder()
			...
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.ENDERMAN, 90, 4, 4)
				.addMobSpawnCost(EntityTypes.ENDERMAN, 0.8, 1)
				.build()
			).generationSettings(new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers)
				.addCarver(StellarityConfiguredCarvers.RAVINE)
				.addCarver(StellarityConfiguredCarvers.CRACK)
		...
		context.register(WARPED_MARSH, new Biome.BiomeBuilder()
			...
			.setAttribute(EnvironmentAttributes.CREATURE_WORLD_GEN_SPAWN_PROBABILITY, 0.4f)
			.mobSpawnSettings(new MobSpawnSettings.Builder()
				.addSpawn(EntityTypes.FROG, 10, 1, 4)
				.addSpawn(EntityTypes.SHEEP, 12, 1, 4)
				.addSpawn(EntityTypes.PIG, 10, 1, 4)
				.addSpawn(EntityTypes.CHICKEN, 10, 1, 4)
				.addSpawn(EntityTypes.COW, 8, 1, 4)
